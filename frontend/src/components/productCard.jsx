const ProductCard = ({ product, onDeleteProduct }) => {
    ...
    const deleteProduct = async (id) => {
        ...
        try {
            ...
            // Optionally, you can handle the UI update after deletion here
            console.log('Product deleted successfully');
            onDeleteProduct(id); // Call the parent function to update the UI
        } catch (error) {
    ...
    return (
      ...
      <div class="group relative">
        ...
        <div class="mt-4 flex justify-between">
            <div onClick={()=> deleteProduct(product?._id)}><svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
